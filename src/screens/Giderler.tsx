...
export default function Giderler() {
  ...
  const [kind, setKind] = useState<'gunluk' | 'aylik'>('gunluk')
  ...
  function ekle() {
    const e: Expense = {
      ...
      amount,
      kind,
      paidCash: kind === 'gunluk' ? paidCash : false,
    }
    saveExpense(e)
    setName('')
    setAmount(0)
  ...
  return (
    <>
      ...
      <div className="stats">
        ...
        <div className="stat">
          <div className="k">Günlük payı</div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <div className="row">
          ...
          <div className="field" style={{ width: 150 }}>
            ...
            <select
              value={kind}
              onChange={(e) => setKind(e.target.value as 'gunluk' | 'aylik')}
            >
              <option value="gunluk">Günlük (bugün)</option>
      ...
      <div className="section-title">Günlük giderler</div>
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        <table>
          <thead>
            <tr>
